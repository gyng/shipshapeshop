...
export const UPGRADE_INFO: Record<string, { name: string; desc: string; icon: string; short?: string; step?: number; unit?: string }> = {
  ...
  auto_tactics: { name: 'Auto-Tactics', icon: '🧠', short: 'Parties fight smart', desc: 'Teach your parties to fight on their own — without orders they now heal when allies are hurt, guard, and unleash ultimates at the right moment (instead of just attacking). You can still write Tactics to override.' },
  gambit_logic_2: { name: 'Gambit Logic II', icon: '🔧', short: '+ targeting & conditions', desc: 'Deeper Tactics — unlocks the "when a skill is ready" and "an ally is badly hurt" conditions, plus attack-the-weakest and attack-the-biggest-threat targeting.' },
  gambit_logic_3: { name: 'Gambit Logic III', icon: '⚙️', short: '+ deep tactics', desc: 'The deepest Tactics — unlocks the "when my ultimate is ready" condition plus the rally (team buff) and sweep (hit-all) actions.' },
  // ── Orrery branch ──
