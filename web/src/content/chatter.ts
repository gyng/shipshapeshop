...
export const CHATTER: Record<string, string[]> = {
  ...
  torus: ['Is the hole half-empty, or half-full?', 'Don’t mind me — just worrying.', 'One loop, round and round.', 'Went down into the dark once. Came back round. You always come back round.'],
  mobius: ['One side. I checked both — same side.', 'Follow my edge; you’ll come back… flipped.', 'Left is right is left, with me.', 'Went in the front, came out the back. Same trip, honestly.'],
  genus2: ['Two holes, so I worry in stereo.', 'Glued from two worriers. It shows.'],
  heptoroid: ['Seven holes, seven things to mind.', 'For a while in the dark I minded none of them. It’s good to have the hands working again.', 'Wide, not deep — that’s the whole trick of me.'],
  trefoil: ['I can’t be undone — that’s just— my whole thing.', 'Three crossings, one me.', 'Go on, try to untangle me.'],
  klein_bottle: ['Inside is outside is in— where was I?', 'Pour me a drink; it spills back into me.', 'No inside. No outside. Just me, folding through.', 'Down deep I lost which side was in. Someone up here had a towel.'],
  ...
  tesseract: ['You only ever see my shadow.', 'In four dimensions, I’m perfectly ordinary.', 'Rotate me — mind the corners.', 'They came down for me when all they could see was my shadow. I remember that.'],
