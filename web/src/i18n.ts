...
const STR: Dict = {
  ...
  'orrery.budget': { en: 'budget', ja: '予算', zh: '预算' },
  ...
  'orrery.timeline': { en: 'Cycle', ja: 'サイクル', zh: '周期' },
  'orrery.tick': { en: 'tick', ja: 'ティック', zh: '拍' },
  ...
  'orrery.rotate': { en: 'Rotate lane', ja: 'レーン回転', zh: '旋转轨道' },
  'orrery.axis': { en: 'axis', ja: '軸', zh: '轴' },
  'orrery.dragHint': { en: 'Drag the gem on the grid to move its anchor.', ja: 'グリッド上の宝石をドラッグしてアンカーを移動。', zh: '在网格上拖动宝石以移动其锚点。' },
